/* Daniel Santana Souza 2310995 3WA */
...
void cria_func(void* f, DescParam params[], int n, unsigned char codigo[]) {
    ...
    Na entrada da funcao gerada %rsp = ...8 (mod 16); apos o push de %rbp a pilha fica alinhada em 16 bytes. Como nao empilha mais nada, a pilha
    permanece alinhada na hora do call, o que e necessario para chamar funcoes de biblioteca (ex.: memcmp). */
    ...
    /*
     Para mover os parâmetros entre os registradores sem apagar nenhum dado, 
     a transferência é feita de trás para frente. Como o registrador de destino está sempre na mesma posição ou à frente do de origem,
     esse fluxo impede que um valor seja sobrescrito antes de ser usado.
     */
    j = 0;
    for (i = 0; i < n; i++) {
    ...
    /*
     parametros amarrados (FIX e IND).
